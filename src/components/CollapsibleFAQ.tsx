...
export default function CollapsibleFAQ() {
  ...
  const faqData: FAQItem[] = [
    {
      question: "هل رسوم توثيق الكلمة قابلة للاسترداد؟ (سياسة الاسترداد)",
      answer: "بسبب تخصيص الشهادة مباشرة بعد الإنشاء، قد لا يكون الاسترداد متاحًا بعد اكتمال التنفيذ.",
      isImportant: true,
    },
    {
      question: "كيف أحصل على الشهادة الرقمية المخصصة؟",
      answer: "بعد إتمام السداد السريع والآمن ببطاقتك أو عبر PayPal، يصار إلى توليد وتوثيق الشهادة الرقمية الفاخرة فورياً. ستحصل على بريد ترحيبي برابط تشاركي مخصص لعرضها، كما تتاح إمكانية تنزيل الشهادة بصيغة PDF عالية الدقة مجهزة للطباعة لتبدو بمظهر ملكي فخم.",
    },
    {
      question: "هل يمكنني تعديل الاسم أو الاقتباس المهدى لاحقاً؟",
      answer: "بعد اكتمال إصدار الشهادة الرقمية وحفظها بالديوان، يصعب تعديل الاسم أو اللفظ مباشرة نظراً لارتباط الشهادة تلقائياً بنظام تصميم خطي وتعبيري مخصص. نرجو مراجعة كافة الحروف والتحقق بدقة قبل تأكيد الطلب.",
    },
    {
      question: "كيف يتم تصنيف الكلمة وتحديد قيمة تسجيلها؟",
      answer: "يتم تقييم كل كلمة عربية ديناميكياً لتأكيد عدم حجزها سابقاً ولتغطية تكاليف الحوسبة الرمزية ومعالجة الذكاء الاصطناعي المخصصة لإصدار الشهادة الفندقية الرقمية.",
    },
    {
      question: "كيف يمكنني السداد إذا لم يكن لدي حساب PayPal؟",
      answer: "يتيح النظام الدفع المباشر والآمن بواسطة بطاقة الائتمان أو بطاقة الدفع المباشر دون الحاجة لامتلاك حساب على قنوات PayPal؛ ما عليك سوى النقر على زر السداد واختيار خيار الدفع بواسطة البطاقة.",
    },
    {
      question: "ما هو حائط ملاك الكلمات بالديوان؟",
      answer: "هو جدار أدبي تفاعلي ممتد عبر الويب لتقدير زوار ومحبي اللغة العربيّة الذين صمموا كلماتهم. إنه بمثابة سجل أدبي معاصر يعكس الألفاظ الأكثر تلامساً ودفئاً في مجتمعنا اللغوي والوجداني."
    }
  ];
